   ...
   // public List<GameObject> RoomStorage = new List<GameObject>();
    ...
    private void BuildTop()
    {
        if (BinaryInteger == 1)
        {
            ...
            Instantiate(SouthRoom[SelectSouthRoom], new Vector3(transform.position.x, transform.position.y + Range, transform.position.z), Quaternion.identity, _Parent.transform);
             }
        ...
        if (BinaryInteger == 2)
        {
            for (int i = 0; i < 1; i++)
            {
                ...
                Instantiate(DeadEnd, new Vector3(transform.position.x, transform.position.y + Range / 2, transform.position.z), Quaternion.Euler(0, 0, 90), _Parent.transform);
            }
        }
        if(BinaryInteger == 3)
        {
    ...
    private void BuildBot()
    {
        ...
        {// Construire une salle 
            ...
            { 
                Instantiate(tunnel, new Vector3(transform.position.x, transform.position.y + 1, transform.position.z), Quaternion.Euler(0, 0, -90), _Parent.transform);           
                Instantiate(NorthRoom[SelectNorthRoom], new Vector3(transform.position.x, transform.position.y - Range, transform.position.z), Quaternion.identity, _Parent.transform);
    ...
    private void BuildLeft()
    {
        ...
        {// Construire une salle et un couloir
            for (int i = 0; i < 1; i++)
            {  
                Instantiate(tunnel, new Vector3(transform.position.x + 1, transform.position.y, transform.position.z), Quaternion.Euler(0, 0, -180), _Parent.transform);
               
                Instantiate(RightRoom[SelectRightRoom], new Vector3(transform.position.x - Range, transform.position.y, transform.position.z), Quaternion.identity, _Parent.transform);
            }
        }
        if (BinaryInteger == 2)
        {// Construire un cul de sac
            for (int i = 0; i < 1; i++)
            {
                ...
                Instantiate(DeadEnd, new Vector3(transform.position.x - Range / 2, transform.position.y, transform.position.z), Quaternion.Euler(0, 0, 180), _Parent.transform);
            }
        }
        if (BinaryInteger == 3)
    ...
    private void BuildRight()
    {
        ...
        {// Construire une salle et un couloir
            for (int i = 0; i < 1; i++)
            {  
                Instantiate(tunnel, new Vector3(transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity, _Parent.transform);
               
                Instantiate(LeftRoom[SelectLeftRoom], new Vector3(transform.position.x + Range, transform.position.y, transform.position.z), Quaternion.identity, _Parent.transform);
            }
        }
        if (BinaryInteger == 2)
        {// Construire un cul de sac
            for (int i = 0; i < 1; i++)
            {
                ...
                Instantiate(DeadEnd, new Vector3(transform.position.x + Range / 2, transform.position.y, transform.position.z), Quaternion.identity, _Parent.transform);
            }
        }
        if (BinaryInteger == 3)
        {// Construire un couloir
